...
public class StudentManager {
    public static final String PATH_NAME = "E:\\btvn\\MD2.CSV\\src\\com\\student.csv";
    ...
    public Student editStudent(String name) {
        ...
        if (editStudent != null) {
            ...
            editStudent.setAvg(scanner.nextDouble());
            scanner.nextLine();
            if (checkAgeAndAverage(editStudent.getAge(), editStudent.getAvg()) && !getGenderByChoice(gender).equals("")) {
    ...
    public void displayStudentFormat() {
        ...
        for (Student student : students) {
            if (student.getAvg() > 8.0) {
                System.out.println(student.getName() + " - " + student.getAvg() + " - " + "Good");
            } else if (student.getAvg() > 6.0) {
                System.out.println(student.getName() + " - " + student.getAvg() + " - " + "Pretty");
            } else if (student.getAvg() > 4.0) {
                System.out.println(student.getName() + " - " + student.getAvg() + " - " + "Normal");
            } else {
                System.out.println(student.getName() + " - " + student.getAvg() + " - " + "Weak");
            }
        }
    }
        ...
        try {
            ...
            for (Student student : students) {
                bufferedWriter.write(student.getName() + "," + student.getAge() + ","
                        + student.getGender() + "," + student.getAddress() + "," + student.getAvg() +"\n");
            }
