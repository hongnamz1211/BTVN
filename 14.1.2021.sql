...
--- 3 Dong xe co 5 cho ngoi
select * from dongxe
where SoChoNgoi > 5;

--- 4 các nhà cung cấp đã từng đăng ký cung cấp những dòng xe thuộc hãng xe “Toyota” với mức phí có đơn giá là 15.000 VNĐ/km	
SELECT nhacungcap.manhacc, nhacungcap.tennhacc, nhacungcap.diachi
FROM nhacungcap, dangkycungcap, dongxe, mucphi
WHERE (nhacungcap.manhacc = dangkycungcap.manhacc
AND dangkycungcap.dongxe = dongxe.dongxe
AND dongxe.hangxe = 'Toyota'
AND dangkycungcap.mamp = mucphi.mamp
AND mucphi.dongia = '15000'
)
...
WHERE (nhacungcap.manhacc = dangkycungcap.manhacc
AND dangkycungcap.dongxe = dongxe.dongxe
AND dongxe.hangxe = 'kia'
AND dangkycungcap.mamp = mucphi.mamp
AND mucphi.dongia = '20000'
)
GROUP BY nhacungcap.manhacc;

--- 5
SELECT * FROM nhacungcap
ORDER BY nhacungcap.tennhacc, nhacungcap.masothue DESC;

--- 6
SELECT dangkycungcap.manhacc,nhacungcap.tennhacc, count(*)
FROM nhacungcap, dangkycungcap
WHERE (nhacungcap.manhacc = dangkycungcap.manhacc
AND dangkycungcap.ngaybatdaucungcap >= '2015/11/20')
...
SELECT dangkycungcap.madkcc, dangkycungcap.manhacc, nhacungcap.tennhacc, nhacungcap.diachi,
			nhacungcap.masothue, loaidichvu.tenloaidv, mucphi.dongia, dongxe.hangxe, 
...
--- 9
SELECT nhacungcap.manhacc, nhacungcap.tennhacc, nhacungcap.diachi
FROM nhacungcap, dangkycungcap, dongxe
WHERE (nhacungcap.manhacc = dangkycungcap.manhacc
AND dangkycungcap.dongxe = dongxe.dongxe
AND dongxe.dongxe = 'Hiace');

SELECT nhacungcap.manhacc, nhacungcap.tennhacc, nhacungcap.diachi
FROM nhacungcap, dangkycungcap, dongxe
WHERE (nhacungcap.manhacc = dangkycungcap.manhacc
AND dangkycungcap.dongxe = dongxe.dongxe
AND dongxe.dongxe = 'cerato');

--- 10	
SELECT nhacungcap.manhacc, nhacungcap.tennhacc
FROM nhacungcap
WHERE NOT EXISTS (SELECT dangkycungcap.manhacc
					FROM dangkycungcap
